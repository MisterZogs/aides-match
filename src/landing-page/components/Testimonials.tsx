...
export default function Testimonials({
  ...
  return (
    <div className="mx-auto mt-16 max-w-7xl sm:mt-20 sm:px-6 lg:px-8">
      <SectionTitle title="Ce qu'en disent nos utilisateurs" />
              ...
              <CardFooter className="flex flex-col pt-0">
                ...
                >
                  {testimonial.avatarSrc ? (
                    ...
                    <div className="ring-border/20 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary/10 text-sm font-semibold text-primary ring-2">
