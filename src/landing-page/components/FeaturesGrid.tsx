...
const FeaturesGrid = ({ features, className = "" }: FeaturesGridProps) => {
  return (
    <div
      className="mx-auto my-12 flex max-w-7xl flex-col gap-4 md:my-16 lg:my-20"
      id="features"
    >
      <SectionTitle
        title="Tout ce dont vous avez besoin"
        description="Un moteur complet pour trouver, comprendre et suivre les aides publiques auxquelles votre entreprise a droit."
      />
      <div
        className={cn(
